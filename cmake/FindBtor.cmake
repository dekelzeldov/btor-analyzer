...
set(BTOR_ROOT "" CACHE PATH "Root of BTOR compiled source tree.")
...
if (DEFINED ABC_SOURCE_DIR)
  ...
  find_path(ABC_INCLUDE_DIR NAMES btor2parser/btor2parser.h PATHS ${BTOR_ROOT}/src)
  find_library(ABC_LIBRARY NAMES abc PATHS ${BTOR_ROOT})
endif()
